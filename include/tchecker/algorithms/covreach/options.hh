  ...
  namespace covreach {
    ...
    public:
      ...
      enum algorithm_model_t {
        ...
        ASYNC_ZG_ELAPSED_EXTRAM_PLUS_G,
        ASYNC_ZG_ELAPSED_EXTRAM_PLUS_L,
        ASYNC_ZG_ELAPSED_EXTRALU_G,
        ...
        ASYNC_ZG_NON_ELAPSED_EXTRAM_PLUS_G,
        ASYNC_ZG_NON_ELAPSED_EXTRAM_PLUS_L,
        ASYNC_ZG_NON_ELAPSED_EXTRALU_G,
        ASYNC_ZG_NON_ELAPSED_EXTRALU_L,
        ASYNC_ZG_NON_ELAPSED_EXTRALU_PLUS_G,
