...
#include "tchecker/algorithms/covreach/instances/por-por3.hh"
#include "tchecker/algorithms/covreach/instances/por-por4.hh"
#include "tchecker/algorithms/covreach/instances/por-por5.hh"
#include "tchecker/algorithms/covreach/instances/por-mag.hh"
#include "tchecker/algorithms/covreach/instances/por-rr.hh"
...
namespace tchecker {
  ...
  namespace covreach {
    ...
    namespace details {
      ...
      /*!
       \brief Run covering reachabilty algorithm with POR for por3 reduction
       \tparam GRAPH_OUTPUTTER : type of graph outputter
       \tparam WAITING : type of waiting container
       \param sysdecl : a system declaration
       \param log : logging facility
       ...
       */
      template <template <class N, class E, class NO, class EO> class GRAPH_OUTPUTTER, template <class NPTR> class WAITING>
      void run_source_set_por3(tchecker::parsing::system_declaration_t const & sysdecl,
                                        tchecker::covreach::options_t const & options,
                                        tchecker::log_t & log)
      {
        switch (options.algorithm_model()) {
          case tchecker::covreach::options_t::ASYNC_ZG_ELAPSED:
            if (options.spread() == tchecker::covreach::options_t::UNBOUNDED_SPREAD)
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::por3::async_zg::ta::
              algorithm_model_t<tchecker::async_zg::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            else
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::por3::async_zg::bounded_spread::ta::
              algorithm_model_t<tchecker::async_zg::bounded_spread::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            break;
       ...
       /*!
       \brief Run covering reachabilty algorithm with POR for por4 reduction
       \tparam GRAPH_OUTPUTTER : type of graph outputter
       \tparam WAITING : type of waiting container
       \param sysdecl : a system declaration
       \param log : logging facility
       ...
       */
      template <template <class N, class E, class NO, class EO> class GRAPH_OUTPUTTER, template <class NPTR> class WAITING>
      void run_source_set_por4(tchecker::parsing::system_declaration_t const & sysdecl,
                                        tchecker::covreach::options_t const & options,
                                        tchecker::log_t & log)
      {
        switch (options.algorithm_model()) {
          case tchecker::covreach::options_t::ASYNC_ZG_ELAPSED:
            if (options.spread() == tchecker::covreach::options_t::UNBOUNDED_SPREAD)
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::por4::async_zg::ta::
              algorithm_model_t<tchecker::async_zg::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            else
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::por4::async_zg::bounded_spread::ta::
              algorithm_model_t<tchecker::async_zg::bounded_spread::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            break;
      ...
      /*!
       \brief Run covering reachabilty algorithm with POR for por5 reduction
       \tparam GRAPH_OUTPUTTER : type of graph outputter
       \tparam WAITING : type of waiting container
       \param sysdecl : a system declaration
       \param log : logging facility
       ...
       */
      template <template <class N, class E, class NO, class EO> class GRAPH_OUTPUTTER, template <class NPTR> class WAITING>
      void run_source_set_por5(tchecker::parsing::system_declaration_t const & sysdecl,
                                        tchecker::covreach::options_t const & options,
                                        tchecker::log_t & log)
      {
        switch (options.algorithm_model()) {
          case tchecker::covreach::options_t::ASYNC_ZG_ELAPSED:
            if (options.spread() == tchecker::covreach::options_t::UNBOUNDED_SPREAD)
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::por5::async_zg::ta::
              algorithm_model_t<tchecker::async_zg::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            else
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::por5::async_zg::bounded_spread::ta::
              algorithm_model_t<tchecker::async_zg::bounded_spread::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            break;
     ...
     /*!
       \brief Run covering reachabilty algorithm with POR for mag reduction
       \tparam GRAPH_OUTPUTTER : type of graph outputter
       \tparam WAITING : type of waiting container
       \param sysdecl : a system declaration
       \param log : logging facility
       ...
       */
      template <template <class N, class E, class NO, class EO> class GRAPH_OUTPUTTER, template <class NPTR> class WAITING>
      void run_source_set_mag(tchecker::parsing::system_declaration_t const & sysdecl,
                                        tchecker::covreach::options_t const & options,
                                        tchecker::log_t & log)
      {
        switch (options.algorithm_model()) {
          case tchecker::covreach::options_t::ASYNC_ZG_ELAPSED:
            if (options.spread() == tchecker::covreach::options_t::UNBOUNDED_SPREAD)
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::mag::async_zg::ta::
              algorithm_model_t<tchecker::async_zg::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            else
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::mag::async_zg::bounded_spread::ta::
              algorithm_model_t<tchecker::async_zg::bounded_spread::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            break;
      ...
      /*!
       \brief Run covering reachabilty algorithm with POR for rr reduction
       \tparam GRAPH_OUTPUTTER : type of graph outputter
       \tparam WAITING : type of waiting container
       \param sysdecl : a system declaration
       \param log : logging facility
       ...
       */
      template <template <class N, class E, class NO, class EO> class GRAPH_OUTPUTTER, template <class NPTR> class WAITING>
      void run_source_set_rr(tchecker::parsing::system_declaration_t const & sysdecl,
                                        tchecker::covreach::options_t const & options,
                                        tchecker::log_t & log)
      {
        switch (options.algorithm_model()) {
          case tchecker::covreach::options_t::ASYNC_ZG_ELAPSED:
            if (options.spread() == tchecker::covreach::options_t::UNBOUNDED_SPREAD)
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::rr::async_zg::ta::
              algorithm_model_t<tchecker::async_zg::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            else
              tchecker::covreach::details::run_async_zg
              <tchecker::covreach::details::por::rr::async_zg::bounded_spread::ta::
              algorithm_model_t<tchecker::async_zg::bounded_spread::ta::elapsed_no_extrapolation_t>,
              GRAPH_OUTPUTTER, WAITING>
              (sysdecl, options, log);
            break;
               ...
               tchecker::log_t & log)
      {
        ...
        else if (options.source_set() == tchecker::covreach::options_t::SOURCE_SET_POR3) {
          run_source_set_por3<GRAPH_OUTPUTTER, WAITING>(sysdecl, options, log);
          return;
        }
        else if (options.source_set() == tchecker::covreach::options_t::SOURCE_SET_POR4) {
          run_source_set_por4<GRAPH_OUTPUTTER, WAITING>(sysdecl, options, log);
          return;
        }
        else if (options.source_set() == tchecker::covreach::options_t::SOURCE_SET_POR5) {
        ...
        else if (options.source_set() == tchecker::covreach::options_t::SOURCE_SET_RR) {
          run_source_set_rr<GRAPH_OUTPUTTER, WAITING>(sysdecl, options, log);
          return;
        }
