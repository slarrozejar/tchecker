...
#ifndef TCHECKER_ALGORITHMS_COVREACH_POR_POR2_HH
#define TCHECKER_ALGORITHMS_COVREACH_POR_POR2_HH
...
#include "tchecker/por/por2/builder.hh"
#include "tchecker/por/por2/output.hh"
#include "tchecker/por/por2/state.hh"
#include "tchecker/por/por2/ts.hh"
          ...
          namespace async_zg {
            ...
            namespace ta {
              ...
              /*!
               ...
               \brief Model for covering reachability asynchronous zone graphs of por2 timed automata with POR
               */
              ...
              public:
                ...
                using ts_t = tchecker::por::por2::ts_t<typename zone_semantics_t::ts_t>;
                ...
                public:
                  using node_ptr_t
                  = typename tchecker::covreach::details::por::por2::async_zg::ta::
                  algorithm_model_t<ZONE_SEMANTICS>::node_ptr_t;

                  state_predicate_t(tchecker::event_map_t const & local,
                                              tchecker::event_map_t const & sync)
                  : _local_enabled(local), _sync_enabled(sync)
                  {}
                  ...
                  bool operator() (node_ptr_t const & n1, node_ptr_t const & n2)
                  {
                    return ((static_cast<tchecker::ta::state_t const &>(*n1)
                            ...
                            &&
                            tchecker::por::por2::cover_leq(*n1, *n2, _local_enabled, _sync_enabled)
                            );
                  }
                private:
                  tchecker::event_map_t _local_enabled;
                  tchecker::event_map_t _sync_enabled;
                };
                ...
                public:
                  bool operator() (node_ptr_t const & n1, node_ptr_t const & n2) const
                  {
                    ...
                    if (cmp > 0)
                      return false;
                    return tchecker::por::por2::lexical_cmp(*n1, *n2) < 0;
                  }
                };

                static std::tuple<tchecker::event_map_t, tchecker::event_map_t> state_predicate_args(model_t const & model)
                {
                  return std::tuple<tchecker::event_map_t, tchecker::event_map_t>(tchecker::local_map(model.system()), tchecker::synchronization_map(model.system()));
                }
                ...
                = tchecker::por::por2::state_outputter_t
            ...
            namespace sync_zones {
              ...
              namespace ta {
                ...
                /*!
                 \class algorithm_model_t
                 \brief Model for covering reachability over por2 timed automata with POR
                 */
                template <class ZONE_SEMANTICS>
                class algorithm_model_t {
                public:
                ...
                public:
                  using node_ptr_t
                  = typename tchecker::covreach::details::por::por2::async_zg::sync_zones::ta::algorithm_model_t<ZONE_SEMANTICS>::node_ptr_t;
            ...
            namespace bounded_spread {
              ...
              namespace ta {
                ...
                /*!
                 ...
                 of por2 timed automata with POR
                 */
                template <class ZONE_SEMANTICS>
                class algorithm_model_t {
                public:
                  ...
                  public:
                    using node_ptr_t
                    = typename tchecker::covreach::details::por::por2::async_zg::bounded_spread::ta::
                      algorithm_model_t<ZONE_SEMANTICS>::node_ptr_t;
...
#endif // TCHECKER_ALGORITHMS_COVREACH_POR_POR2_HH
