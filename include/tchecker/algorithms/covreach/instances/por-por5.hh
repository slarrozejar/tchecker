...
#ifndef TCHECKER_ALGORITHMS_COVREACH_POR_POR5_HH
#define TCHECKER_ALGORITHMS_COVREACH_POR_POR5_HH
...
#include "tchecker/por/por5/builder.hh"
#include "tchecker/por/por5/output.hh"
#include "tchecker/por/por5/state.hh"
#include "tchecker/por/por5/ts.hh"

/*!
 \file por-por5.hh
 \brief Instantiation of covreach algorithm for asynchronous zone graph with
 por5 partial-order reduction
 */
          ...
          namespace async_zg {
            ...
            namespace ta {
              ...
              /*!
               ...
               \brief Model for covering reachability asynchronous zone graphs of por5 timed automata with POR
               */
              ...
              public:
                ...
                using ts_t = tchecker::por::por5::ts_t<typename zone_semantics_t::ts_t>;
                ...
                using builder_t = tchecker::por::por5::states_builder_t<ts_t, ts_allocator_t>;
                ...
                public:
                  using node_ptr_t
                  = typename tchecker::covreach::details::por::por5::async_zg::ta::
                  ...
                  bool operator() (node_ptr_t const & n1, node_ptr_t const & n2)
                  {
                    return ((static_cast<tchecker::ta::state_t const &>(*n1)
                            ...
                            &&
                            tchecker::por::por5::cover_leq(*n1, *n2)
                            );
                  }
                };
                ...
                public:
                  bool operator() (node_ptr_t const & n1, node_ptr_t const & n2) const
                  {
                    ...
                    if (cmp > 0)
                      return false;
                    return tchecker::por::por5::lexical_cmp(*n1, *n2) < 0;
                  }
                };
                ...
                = tchecker::por::por5::state_outputter_t
            ...
            namespace sync_zones {
              ...
              namespace ta {
                ...
                /*!
                 \class algorithm_model_t
                 \brief Model for covering reachability over por5 timed automata with POR
                 */
                template <class ZONE_SEMANTICS>
                class algorithm_model_t {
                public:
                  ...
                  public:
                    using node_ptr_t
                    = typename tchecker::covreach::details::por::por5::async_zg::sync_zones::ta::algorithm_model_t<ZONE_SEMANTICS>::node_ptr_t;
            ...
            namespace bounded_spread {
              ...
              namespace ta {
                ...
                /*!
                 ...
                 of por5 timed automata with POR
                 */
                template <class ZONE_SEMANTICS>
                class algorithm_model_t {
                public:
                  ...
                  public:
                    using node_ptr_t
                    = typename tchecker::covreach::details::por::por5::async_zg::bounded_spread::ta::
                    algorithm_model_t<ZONE_SEMANTICS>::node_ptr_t;
...
#endif // TCHECKER_ALGORITHMS_COVREACH_POR_POR5_HH
