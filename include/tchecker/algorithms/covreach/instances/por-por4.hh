...
#ifndef TCHECKER_ALGORITHMS_COVREACH_POR_POR4_HH
#define TCHECKER_ALGORITHMS_COVREACH_POR_POR4_HH
...
#include "tchecker/por/por4/builder.hh"
#include "tchecker/por/por4/output.hh"
#include "tchecker/por/por4/state.hh"
#include "tchecker/por/por4/ts.hh"

/*!
 \file por-por4.hh
 \brief Instantiation of covreach algorithm for asynchronous zone graph with
 por4 partial-order reduction
 */
          ...
          namespace async_zg {
            ...
            namespace ta {
              ...
              /*!
               ...
               \brief Model for covering reachability asynchronous zone graphs of por4 timed automata with POR
               */
              ...
              public:
                ...
                using ts_t = tchecker::por::por4::ts_t<typename zone_semantics_t::ts_t>;
                ...
                using builder_t = tchecker::por::por4::states_builder_t<ts_t, ts_allocator_t>;
                ...
                public:
                  using node_ptr_t
                  = typename tchecker::covreach::details::por::por4::async_zg::ta::
                ...
                public:
                  bool operator() (node_ptr_t const & n1, node_ptr_t const & n2) const
                  {
                    ...
                    if (cmp > 0)
                      return false;
                    return tchecker::por::por4::lexical_cmp(*n1, *n2) < 0;
                  }
                };
                ...
                = tchecker::por::por4::state_outputter_t
            ...
            namespace sync_zones {
              ...
              namespace ta {
                ...
                /*!
                 \class algorithm_model_t
                 \brief Model for covering reachability over por4 timed automata with POR
                 */
                template <class ZONE_SEMANTICS>
                class algorithm_model_t {
                public:
                  ...
                  public:
                    using node_ptr_t
                    = typename tchecker::covreach::details::por::por4::async_zg::sync_zones::ta::algorithm_model_t<ZONE_SEMANTICS>::node_ptr_t;
            ...
            namespace bounded_spread {
              ...
              namespace ta {
                ...
                /*!
                 ...
                 of por4 timed automata with POR
                 */
                template <class ZONE_SEMANTICS>
                class algorithm_model_t {
                public:
                  ...
                  public:
                    using node_ptr_t
                    = typename tchecker::covreach::details::por::por4::async_zg::bounded_spread::ta::
                    algorithm_model_t<ZONE_SEMANTICS>::node_ptr_t;
...
#endif // TCHECKER_ALGORITHMS_COVREACH_POR_POR4_HH
