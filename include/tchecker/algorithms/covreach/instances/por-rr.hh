...
#ifndef TCHECKER_ALGORITHMS_COVREACH_POR_RR_HH
#define TCHECKER_ALGORITHMS_COVREACH_POR_RR_HH
...
#include "tchecker/por/rr/builder.hh"
#include "tchecker/por/rr/output.hh"
#include "tchecker/por/rr/state.hh"
#include "tchecker/por/rr/ts.hh"

/*!
 \file por-rr.hh
 \brief Instantiation of covreach algorithm for asynchronous zone graph with
 rr partial-order reduction
 */
          ...
          namespace async_zg {
            ...
            namespace ta {
              ...
              /*!
               ...
               \brief Model for covering reachability asynchronous zone graphs of rr timed automata with POR
               */
              ...
              public:
                ...
                using ts_t = tchecker::por::rr::ts_t<typename zone_semantics_t::ts_t>;
                ...
                using builder_t = tchecker::por::rr::states_builder_t<ts_t, ts_allocator_t>;
                ...
                public:
                  using node_ptr_t
                  = typename tchecker::covreach::details::por::rr::async_zg::ta::
                  ...
                  bool operator() (node_ptr_t const & n1, node_ptr_t const & n2)
                  {
                    return ((static_cast<tchecker::ta::state_t const &>(*n1)
                            ...
                            &&
                            tchecker::por::rr::cover_leq(*n1, *n2)
                            );
                  }
                };
                ...
                public:
                  bool operator() (node_ptr_t const & n1, node_ptr_t const & n2) const
                  {
                    ...
                    if (cmp > 0)
                      return false;
                    return tchecker::por::rr::lexical_cmp(*n1, *n2) < 0;
                  }
                };
                ...
                = tchecker::por::rr::state_outputter_t
            ...
            namespace sync_zones {
              ...
              namespace ta {
                ...
                /*!
                 \class algorithm_model_t
                 \brief Model for covering reachability over rr timed automata with POR
                 */
                template <class ZONE_SEMANTICS>
                class algorithm_model_t {
                public:
                  ...
                  public:
                    using node_ptr_t
                    = typename tchecker::covreach::details::por::rr::async_zg::sync_zones::ta::algorithm_model_t<ZONE_SEMANTICS>::node_ptr_t;
            ...
            namespace bounded_spread {
              ...
              namespace ta {
                ...
                public:
                  ...
                  public:
                    using node_ptr_t
                    = typename tchecker::covreach::details::por::rr::async_zg::bounded_spread::ta::
                    algorithm_model_t<ZONE_SEMANTICS>::node_ptr_t;
...
#endif // TCHECKER_ALGORITHMS_COVREACH_POR_RR_HH
