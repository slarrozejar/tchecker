...
#ifndef TCHECKER_ASYNC_ZG_BOUNDED_SPREAD_DETAILS_ZG_HH
#define TCHECKER_ASYNC_ZG_BOUNDED_SPREAD_DETAILS_ZG_HH
...
/*!
 \file zg.hh
 \brief Asynchronous zone graph with bounded spread (details)
 */
    ...
    namespace bounded_spread {
      ...
      namespace details {
        ...
        public:
          ...
          /*!
           \brief Constructor
           \tparam ASYNC_MODEL : type of model, should derive from tchecker::async_zg::bounded_spread::details::model_t
           \param model : a model
           ...
           */
          zg_t(tchecker::async_zg::bounded_spread::details::zg_t<TA, ASYNC_ZONE_SEMANTICS> const &) = default;
          
          /*!
           \brief Move constructor
           */
          zg_t(tchecker::async_zg::bounded_spread::details::zg_t<TA, ASYNC_ZONE_SEMANTICS> &&) = default;
           ...
           */
          tchecker::async_zg::bounded_spread::details::zg_t<TA, ASYNC_ZONE_SEMANTICS> &
          operator= (tchecker::async_zg::bounded_spread::details::zg_t<TA, ASYNC_ZONE_SEMANTICS> const & zg)
          = default;
           ...
           */
          tchecker::async_zg::bounded_spread::details::zg_t<TA, ASYNC_ZONE_SEMANTICS> &
          operator= (tchecker::async_zg::bounded_spread::details::zg_t<TA, ASYNC_ZONE_SEMANTICS> && zg)
          = default;
          ...
          /*!
           ...
           \pre 0 <= spread (checked by assertion)
           see tchecker::ta::details::initialize() and ASYNC_ZONE_SEMANTICS::initialize() for other preconditions
           \return see tchecker::ta::details::initialize() and ASYNC_ZONE_SEMANTICS::initialize() for return values
           */
                                                   ...
                                                   tchecker::integer_t spread)
          {
            ...
            return this->_async_zone_semantics.initialize(offset_zone, spread, this->_src_delay_allowed,
          ...
          /*!
           ...
           \param spread : bound on spread between reference clocks
           \pre See next() for other parameters
           \post See next() for other postconditions
           \return See next() for return values
           */
...
#endif // TCHECKER_ASYNC_ZG_BOUNDED_SPREAD_DETAILS_ZG_HH
