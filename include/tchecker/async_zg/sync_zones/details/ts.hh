...
#ifndef TCHECKER_ASYNC_ZG_SYNC_ZONES_DETAILS_TS_HH
#define TCHECKER_ASYNC_ZG_SYNC_ZONES_DETAILS_TS_HH

#include "tchecker/ts/ts.hh"

/*!
 \file ts.hh
 \brief Transition system interface to asynchronous zone graphs with sync zones
 */
  ...
  namespace async_zg {
    ...
    namespace sync_zones {
      ...
      namespace details {
        ...
        /*!
         \class ts_t
         \brief Transition system for asynchronous zone graphs with sync zones
        ...
        public:
          /*!
           \brief Constructor
           \param model : a model to build ASYNC_ZG, should inherit from tchecker::async_zg::sync_zones::details::model_t
           */
           ...
           */
          ts_t(tchecker::async_zg::sync_zones::details::ts_t<STATE, TRANSITION, ASYNC_ZG> const & ts)
          = default;
           ...
           */
          ts_t(tchecker::async_zg::sync_zones::details::ts_t<STATE, TRANSITION, ASYNC_ZG> && ts)
          = default;
           ...
           */
          tchecker::async_zg::sync_zones::details::ts_t<STATE, TRANSITION, ASYNC_ZG> &
          operator= (tchecker::async_zg::sync_zones::details::ts_t<STATE, TRANSITION, ASYNC_ZG> const & ts)
          = default;
           ...
           */
          tchecker::async_zg::sync_zones::details::ts_t<STATE, TRANSITION, ASYNC_ZG> &
          operator= (tchecker::async_zg::sync_zones::details::ts_t<STATE, TRANSITION, ASYNC_ZG> && ts)
          = default;
          ...
          {
            return _async_zg.next(*s.vloc_ptr(), *s.intvars_val_ptr(), *s.offset_zone_ptr(), *s.sync_zone_ptr(),
...
#endif // TCHECKER_ASYNC_ZG_SYNC_ZONES_DETAILS_TS_HH
