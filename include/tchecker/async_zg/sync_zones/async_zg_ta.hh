...
#ifndef TCHECKER_ASYNC_ZG_SYNC_ZONES_TA_HH
#define TCHECKER_ASYNC_ZG_SYNC_ZONES_TA_HH
...
#include "tchecker/async_zg/sync_zones/details/allocators.hh"
#include "tchecker/async_zg/sync_zones/details/model.hh"
#include "tchecker/async_zg/sync_zones/details/output.hh"
#include "tchecker/async_zg/sync_zones/details/state.hh"
#include "tchecker/async_zg/sync_zones/details/transition.hh"
#include "tchecker/async_zg/sync_zones/details/ts.hh"
#include "tchecker/async_zg/sync_zones/details/variables.hh"
#include "tchecker/async_zg/sync_zones/details/zg.hh"
#include "tchecker/zone/offset_dbm/semantics.hh"

/*!
 \file zg_ta.hh
 \brief Asynchronous zone graph with sync zones for timed automata
 */
...
namespace tchecker {
  ...
  namespace async_zg {
    ...
    namespace sync_zones {
      ...
      namespace ta {
        ...
        = tchecker::async_zg::sync_zones::details::model_t
        <tchecker::ta::system_t, tchecker::async_zg::sync_zones::details::variables_t>;
        
        /*!
         \class model_t
         \brief Model for asynchronous zone graphs with sync zones over timed automata (see tchecker::async_zg::sync_zones::details::model_t)
         */
        class model_t final : public tchecker::async_zg::sync_zones::ta::model_instantiation_t {
        public:
          /*!
           \brief Constructor
          ...
          using tchecker::async_zg::sync_zones::ta::model_instantiation_t::model_t;
        };
        ...
        = tchecker::ta::details::ta_t<tchecker::async_zg::sync_zones::ta::model_t, tchecker::ta::vloc_t,
         ...
         */
        class ta_t final : public tchecker::async_zg::sync_zones::ta::ta_instantiation_t {
        public:
          using tchecker::async_zg::sync_zones::ta::ta_instantiation_t::ta_t;
        };
        ...
        using zg_t
        = tchecker::async_zg::sync_zones::details::zg_t
        <tchecker::async_zg::sync_zones::ta::ta_t, ZONE_SEMANTICS>;
        ...
        using state_t = tchecker::async_zg::sync_zones::details::state_t
        <tchecker::async_zg::sync_zones::ta::shared_vloc_t,
        tchecker::async_zg::sync_zones::ta::shared_intvars_valuation_t,
        tchecker::async_zg::sync_zones::ta::shared_zone_t<OFFSET_ZONE>,
        tchecker::async_zg::sync_zones::ta::shared_zone_t<SYNC_ZONE>,
        tchecker::intrusive_shared_ptr_t<tchecker::async_zg::sync_zones::ta::shared_vloc_t>,
        tchecker::intrusive_shared_ptr_t<tchecker::async_zg::sync_zones::ta::shared_intvars_valuation_t>,
        tchecker::intrusive_shared_ptr_t<tchecker::async_zg::sync_zones::ta::shared_zone_t<OFFSET_ZONE>>,
        tchecker::intrusive_shared_ptr_t<tchecker::async_zg::sync_zones::ta::shared_zone_t<SYNC_ZONE>>
        >;
        ...
        = tchecker::make_shared_t<tchecker::async_zg::sync_zones::ta::state_t<OFFSET_ZONE, SYNC_ZONE>>;
        ...
        : public tchecker::async_zg::sync_zones::details::state_pool_allocator_t<STATE> {
        public:
          /*!
           \brief Constructor
           \param model : a model
           ...
           */
          state_pool_allocator_t(tchecker::async_zg::sync_zones::ta::model_t & model, std::size_t alloc_nb)
          : tchecker::async_zg::sync_zones::details::state_pool_allocator_t<STATE>
          (alloc_nb,
         ...
         */
        using state_outputter_t = tchecker::async_zg::sync_zones::details::state_outputter_t;
        
        
        /*!
         \brief Asynchronous zone graph transition
         */
        using transition_t = tchecker::async_zg::sync_zones::details::transition_t;
        
        
        /*!
         \brief Asynchronous zone graph transition outputter
         */
        using transition_outputter_t = tchecker::async_zg::sync_zones::details::transition_outputter_t;
        ...
        : public tchecker::async_zg::sync_zones::details::transition_singleton_allocator_t<TRANSITION>
        {
          static_assert(std::is_base_of<tchecker::async_zg::sync_zones::ta::transition_t, TRANSITION>::value,
                        "");
        public:
          using tchecker::async_zg::sync_zones::details::transition_singleton_allocator_t<TRANSITION>
        ...
        template <class ZONE_SEMANTICS>
        using ts_t
        = tchecker::async_zg::sync_zones::details::ts_t
        <tchecker::async_zg::sync_zones::ta::state_t<typename ZONE_SEMANTICS::offset_zone_t,
        typename ZONE_SEMANTICS::sync_zone_t>,
        tchecker::async_zg::sync_zones::ta::transition_t,
        tchecker::async_zg::sync_zones::ta::zg_t<ZONE_SEMANTICS>>;
        ...
        namespace details {
          ...
          public:
             ...
             */
            using zg_t = tchecker::async_zg::sync_zones::ta::zg_t<ZONE_SEMANTICS>;
            
            /*!
             \brief Type of state
             */
            using state_t
            = tchecker::async_zg::sync_zones::ta::state_t
            <typename ZONE_SEMANTICS::offset_zone_t, typename ZONE_SEMANTICS::sync_zone_t>;
            
            /*!
             \brief Type of shared state
             */
            using shared_state_t
            = tchecker::async_zg::sync_zones::ta::shared_state_t
            <typename ZONE_SEMANTICS::offset_zone_t, typename ZONE_SEMANTICS::sync_zone_t>;
            ...
            using state_pool_allocator_t = tchecker::async_zg::sync_zones::ta::state_pool_allocator_t<STATE>;
            
            /*!
             \brief Type of transition
             */
            using transition_t = tchecker::async_zg::sync_zones::ta::transition_t;
            ...
            = tchecker::async_zg::sync_zones::ta::transition_singleton_allocator_t<TRANSITION>;
            
            /*!
             \brief Type of transition system
             */
            using ts_t = tchecker::async_zg::sync_zones::ta::ts_t<ZONE_SEMANTICS>;
          };
   ...
   */
  template <class OFFSET_ZONE, class SYNC_ZONE>
  class allocation_size_t<tchecker::async_zg::sync_zones::ta::state_t<OFFSET_ZONE, SYNC_ZONE>> {
  public:
    static constexpr std::size_t alloc_size()
    {
      return sizeof(tchecker::async_zg::sync_zones::ta::state_t<OFFSET_ZONE, SYNC_ZONE>);
    }
  };
  
} // end of namespace tchecker

#endif // TCHECKER_ASYNC_ZG_SYNC_ZONES_TA_HH
