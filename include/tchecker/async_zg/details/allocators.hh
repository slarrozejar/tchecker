...
namespace tchecker {
  ...
  namespace async_zg {
    ...
    namespace details {
      ...
      >
      class state_pool_allocator_t
      : protected tchecker::ta::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL> {
      public:
        /*!
        ...
        _offset_zone_pool(zone_alloc_nb,
                          tchecker::allocation_size_t<OFFSET_ZONE>::alloc_size(_offset_zone_dimension))
        {}
        ...
        (tchecker::async_zg::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL, OFFSET_ZONE> const &)
        = delete;
         ...
         */
        state_pool_allocator_t
        (tchecker::async_zg::details::state_pool_allocator_t<STATE, VLOC, INTVARS_VAL, OFFSET_ZONE> &&)
        = delete;
        ...
        /*!
         ...
         variables, a newly allocated offset zone, and args
         */
        template <class ... ARGS>
        tchecker::intrusive_shared_ptr_t<STATE> construct(ARGS && ... args)
        {
          ...
          (args..., _offset_zone_pool.construct(_offset_zone_dimension));
        }
        ...
        /*!
         ...
         \param state : a state
         \param args : arguments to a constructor of STATE beyond tuple of locations, integer variables valuation and zone
         \return a new instance of STATE constructed from state, a copy of the offset zone in state, and args
         */
        template <class ... ARGS>
      ...
      public:
        using
        tchecker::ta::details::transition_singleton_allocator_t<TRANSITION>::transition_singleton_allocator_t;
      };
