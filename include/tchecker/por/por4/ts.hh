...
#ifndef TCHECKER_POR_POR4_TS_HH
#define TCHECKER_POR_POR4_TS_HH
...
/*!
 \file ts.hh
 \brief Transition system for por4 partial-order reduction
 */
  ...
  namespace por {
    ...
    namespace por4 {
      ...
      */
      ...
      tchecker::por::por4::make_state_t<typename TS::state_t>,
      ...
      {
      public:
        using state_t = tchecker::por::por4::make_state_t<typename TS::state_t>;
        ...
        */
        ts_t(tchecker::por::por4::ts_t<TS> const &) = default;

        /*!
        \brief Move constructor
        */
        ts_t(tchecker::por::por4::ts_t<TS> &&) = default;
        ...
        */
        tchecker::por::por4::ts_t<TS> &
        operator= (tchecker::por::por4::ts_t<TS> const &) = default;

        /*!
        \brief Move-assignment operator
        */
        tchecker::por::por4::ts_t<TS> &
        operator= (tchecker::por::por4::ts_t<TS> &&) = default;
