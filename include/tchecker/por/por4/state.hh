...
#ifndef TCHECKER_POR_POR4_STATE_HH
#define TCHECKER_POR_POR4_STATE_HH
...
namespace tchecker {
    ...
    namespace por4 {
      ...
      */
      ...
      public:
        ...
        */
        bool operator== (tchecker::por::por4::state_t const & s) const;
      ...
      */
      ...
      \note make_state_t<STATE> derives both from STATE and from tchecker::por::por4::state_t
      */
      template <class STATE>
      class make_state_t : public STATE, public tchecker::por::por4::state_t {
      public:
        using STATE::STATE;
        ...
        */
        template <class ... ARGS>
        make_state_t(tchecker::por::por4::make_state_t<STATE> const & s,
                     ARGS && ... args)
        : STATE(s, args...), tchecker::por::por4::state_t(s)
        {}
      };
      ...
      */
      template <class STATE>
      bool operator== (tchecker::por::por4::make_state_t<STATE> const & s1,
                       tchecker::por::por4::make_state_t<STATE> const & s2)
      {
        return
        ((static_cast<tchecker::por::por4::state_t const &>(s1) ==
          static_cast<tchecker::por::por4::state_t const &>(s2))
        &&
      ...
      */
      template <class STATE>
      std::size_t hash_value(tchecker::por::por4::make_state_t<STATE> const & s)
      {
        std::size_t h = tchecker::por::por4::hash_value
        (static_cast<tchecker::por::por4::state_t const &>(s));
      ...
      */
      template <class STATE>
      int lexical_cmp(tchecker::por::por4::make_state_t<STATE> const & s1,
                      tchecker::por::por4::make_state_t<STATE> const & s2)
      {
        ...
        if (cmp != 0)
          return cmp;
        return tchecker::por::por4::lexical_cmp
        (static_cast<tchecker::por::por4::state_t const &>(s1),
         static_cast<tchecker::por::por4::state_t const &>(s2));
      }
  ...
  /*!
   \brief Specialization of class allocation_size_t for tchecker::por::por4::state_t
   */
  template <class STATE>
  class allocation_size_t<tchecker::por::por4::make_state_t<STATE>> {
  public:
    template <class ... ARGS>
    static constexpr std::size_t alloc_size(ARGS && ... args)
    {
      return sizeof(tchecker::por::por4::make_state_t<STATE>);
    }
  };

} // end of namespace tchecker

#endif // TCHECKER_POR_POR4_STATE_HH
