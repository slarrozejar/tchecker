...
#ifndef TCHECKER_POR_RR_TS_HH
#define TCHECKER_POR_RR_TS_HH
...
/*!
 \file ts.hh
 \brief Transition system for rr partial-order reduction
 */
  ...
  namespace por {
    ...
    namespace rr {
      ...
      */
      ...
      tchecker::por::rr::make_state_t<typename TS::state_t>,
      ...
      {
      public:
        using state_t = tchecker::por::rr::make_state_t<typename TS::state_t>;
        ...
        */
        ts_t(tchecker::por::rr::ts_t<TS> const &) = default;

        /*!
        \brief Move constructor
        */
        ts_t(tchecker::por::rr::ts_t<TS> &&) = default;
        ...
        */
        tchecker::por::rr::ts_t<TS> &
        operator= (tchecker::por::rr::ts_t<TS> const &) = default;

        /*!
        \brief Move-assignment operator
        */
        tchecker::por::rr::ts_t<TS> &
        operator= (tchecker::por::rr::ts_t<TS> &&) = default;
