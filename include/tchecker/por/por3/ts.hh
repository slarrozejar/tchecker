...
#ifndef TCHECKER_POR_POR3_TS_HH
#define TCHECKER_POR_POR3_TS_HH
...
/*!
 \file ts.hh
 \brief Transition system for por3 partial-order reduction
 */
  ...
  namespace por {
    ...
    namespace por3 {
      ...
      */
      ...
      tchecker::por::por3::make_state_t<typename TS::state_t>,
      ...
      {
      public:
        using state_t = tchecker::por::por3::make_state_t<typename TS::state_t>;
        ...
        */
        ts_t(tchecker::por::por3::ts_t<TS> const &) = default;

        /*!
        \brief Move constructor
        */
        ts_t(tchecker::por::por3::ts_t<TS> &&) = default;
        ...
        */
        tchecker::por::por3::ts_t<TS> &
        operator= (tchecker::por::por3::ts_t<TS> const &) = default;

        /*!
        \brief Move-assignment operator
        */
        tchecker::por::por3::ts_t<TS> &
        operator= (tchecker::por::por3::ts_t<TS> &&) = default;
