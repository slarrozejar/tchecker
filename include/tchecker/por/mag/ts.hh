...
#ifndef TCHECKER_POR_MAG_TS_HH
#define TCHECKER_POR_MAG_TS_HH
...
/*!
 \file ts.hh
 \brief Transition system for mag partial-order reduction
 */
  ...
  namespace por {
    ...
    namespace mag {
      ...
      */
      ...
      tchecker::por::mag::make_state_t<typename TS::state_t>,
      ...
      {
      public:
        using state_t = tchecker::por::mag::make_state_t<typename TS::state_t>;
        ...
        */
        ts_t(tchecker::por::mag::ts_t<TS> const &) = default;

        /*!
        \brief Move constructor
        */
        ts_t(tchecker::por::mag::ts_t<TS> &&) = default;
        ...
        */
        tchecker::por::mag::ts_t<TS> &
        operator= (tchecker::por::mag::ts_t<TS> const &) = default;

        /*!
        \brief Move-assignment operator
        */
        tchecker::por::mag::ts_t<TS> &
        operator= (tchecker::por::mag::ts_t<TS> &&) = default;
