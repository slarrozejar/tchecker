    ...
    namespace gl {
      ...
      namespace details {
        ...
        public:
           ...
           */
          outgoing_iterator_t
          (tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR> const &) = default;
          
          /*!
           \brief Move constructor
           */
          outgoing_iterator_t
          (tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR> &&) = default;
           ...
           */
          tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR> &
          operator= (tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR> const &)
          = default;
           ...
           */
          tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR> &
          operator= (tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR> &&) = default;
           ...
           */
          inline bool
          operator== (tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR> const & it) const
          {
           ...
           */
          inline tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR> & operator++ ()
          {
            assert(! at_end());
            ++ _outgoing_it;
            skip();
          ...
          /*!
           ...
           \note The edge active pid is set to tchecker::por::gl::details::global on global edges,
        ...
        private:
          /*!
           ...
           Points past-the-end otherwise. All transitions are allowed when _active_pid == tchecker::pro::gl::details::global
           */
          void skip()
          {
            while (! _outgoing_it.at_end()) {
              _vedge_pid = vedge_pid(*_outgoing_it);
              if ((_active_pid == tchecker::por::gl::details::global) || (_vedge_pid >= _active_pid))
                break;
              ++ _outgoing_it;
            }
          }
          ...
          /*!
           ...
           otherwise returns tchecker::por::gl::details::global if vedge is global
          ...
          tchecker::process_id_t vedge_pid(VEDGE const & vedge) const
          {
            ...
            // global vedge
            return tchecker::por::gl::details::global;
          }
...
/*!
 \brief Iterator traits for tchecker::por::gl::details::outgoing_iterator_t
 */
template <class OUTGOING_ITERATOR>
struct std::iterator_traits<tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR>> {
  using difference_type = nullptr_t;
  
  using value_type = typename tchecker::por::gl::details::outgoing_iterator_t<OUTGOING_ITERATOR>::value_type_t;
  ...
  namespace por {
    ...
    namespace gl {
      ...
      namespace details {
        ...
        tchecker::por::gl::details::outgoing_iterator_t<typename TS::outgoing_edges_iterator_t>,
        typename TS::initial_iterator_value_t,
        typename std::iterator_traits<tchecker::por::gl::details::outgoing_iterator_t<typename TS::outgoing_edges_iterator_t>>::value_type
        >;
      ...
      /*!
       ...
       \note ts_t<TS> implements a round-robin POR on top of TS: each node has a rank. From a given node,
       ...
       */
      template <class TS, class STATE>
      class ts_t final : public tchecker::por::gl::details::ts_instance_t<TS, STATE> {
        ...
        using por_ts_t = tchecker::por::gl::details::ts_instance_t<TS, STATE>;
      ...
      public:
        ...
        /*!
         \brief Assignment operator
         */
        tchecker::por::gl::ts_t<TS, STATE> &
        operator= (tchecker::por::gl::ts_t<TS, STATE> const &) = default;
        
        /*!
         \brief Move-assignment oeprator
         */
        tchecker::por::gl::ts_t<TS, STATE> &
        operator= (tchecker::por::gl::ts_t<TS, STATE> &&) = default;
      ...
      private:
        ...
        {
          tchecker::process_id_t rank = (s.rank() == tchecker::por::gl::details::global ? 0 : s.rank());
