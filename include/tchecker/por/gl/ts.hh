...
/*!
 \file ts.hh
 \brief Transition system for global/local partial-order reduction
 */
  ...
  namespace por {
    ...
    namespace gl {
      ...
      */
      ...
      tchecker::por::gl::make_state_t<typename TS::state_t>,
      ...
      {
      public:
        using state_t = tchecker::por::gl::make_state_t<typename TS::state_t>;
        ...
        */
        ts_t(tchecker::por::gl::ts_t<TS> const &) = default;
        
        /*!
        \brief Move constructor
        */
        ts_t(tchecker::por::gl::ts_t<TS> &&) = default;
        ...
        */
        tchecker::por::gl::ts_t<TS> &
        operator= (tchecker::por::gl::ts_t<TS> const &) = default;
        
        /*!
        \brief Move-assignment oeprator
        */
        tchecker::por::gl::ts_t<TS> &
        operator= (tchecker::por::gl::ts_t<TS> &&) = default;
