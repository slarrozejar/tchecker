...
#ifndef TCHECKER_POR_POR5_TS_HH
#define TCHECKER_POR_POR5_TS_HH
...
/*!
 \file ts.hh
 \brief Transition system for por5 partial-order reduction
 */
  ...
  namespace por {
    ...
    namespace por5 {
      ...
      */
      ...
      tchecker::por::por5::make_state_t<typename TS::state_t>,
      ...
      {
      public:
        using state_t = tchecker::por::por5::make_state_t<typename TS::state_t>;
        ...
        */
        ts_t(tchecker::por::por5::ts_t<TS> const &) = default;

        /*!
        \brief Move constructor
        */
        ts_t(tchecker::por::por5::ts_t<TS> &&) = default;
        ...
        */
        tchecker::por::por5::ts_t<TS> &
        operator= (tchecker::por::por5::ts_t<TS> const &) = default;

        /*!
        \brief Move-assignment operator
        */
        tchecker::por::por5::ts_t<TS> &
        operator= (tchecker::por::por5::ts_t<TS> &&) = default;
